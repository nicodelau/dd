...
export class PrismaCharacterRepository implements ICharacterRepository {
  ...
  async create(characterData: Omit<Character, 'id' | 'createdAt' | 'updatedAt'>): Promise<Character> {
    const createData = {
      ...
      stamina: characterData.stamina ?? 100,
      maxStamina: characterData.maxStamina ?? 100,
  ...
  async update(id: string, characterData: Partial<Character>): Promise<Character | null> {
    try {
      ...
      const updateData = {
        ...
        ...(characterData.stamina !== undefined && { stamina: parseIntOrDefault(characterData.stamina, 100) }),
        ...(characterData.maxStamina !== undefined && { maxStamina: parseIntOrDefault(characterData.maxStamina, 100) }),
  ...
  private mapPrismaToEntity(prismaCharacter: any): Character {
    return {
      ...
      stamina: prismaCharacter.stamina,
      maxStamina: prismaCharacter.maxStamina,
