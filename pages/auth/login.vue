        ...
        <div class="mb-8">
          ...
          <div class="space-y-4">
            <div class="flex items-center space-x-3">
              ...
              <span class="text-slate-300">Create and manage characters</span>
            </div>
            <div class="flex items-center space-x-3">
              <div class="w-2 h-2 bg-blue-400 rounded-full"></div>
              <span class="text-slate-300">Track campaigns and sessions</span>
            </div>
            <div class="flex items-center space-x-3">
              <div class="w-2 h-2 bg-purple-400 rounded-full"></div>
              <span class="text-slate-300">Digital dice rolling and stats</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="mx-auto w-full max-w-sm lg:w-96">
        ...
        <div class="hidden lg:block">
          ...
          <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
            Or
            <NuxtLink to="/auth/register" class="font-medium text-emerald-600 hover:text-emerald-500 transition-colors">
